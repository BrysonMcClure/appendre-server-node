...
import {options} from "../documentsMDS/document-schema.js";
...
const letterSchema = mongoose.Schema(
    {
        ...
        //Date note: May not be needed and instead can just use getTimeStamp functionality to just print out time record was added/ last time text field was edited on client side
